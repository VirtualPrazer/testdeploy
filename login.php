            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <div class="text-end">
                        ...
                        <a href="planos.html" class="btn btn-outline-danger">Quero Anunciar</a>
                    </div>
                </div> 
...
<form action="logar.php" method="POST">
  ...
  <div class="form-floating">
    <input type="text" class="form-control text-light bg-dark" id="floatingInput" name="user" placeholder="name@example.com">
    <label for="floatingInput">Usuário</label>
  </div>
  <div class="form-floating">
    <input type="password" class="form-control text-light bg-dark" id="floatingPassword" name="senha" placeholder="Password">
...
<script src="../assets/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <!-- página de login sem precisar de banco de dados, cria um login único (ou não) e faz um script para validar usuario e senha -->
